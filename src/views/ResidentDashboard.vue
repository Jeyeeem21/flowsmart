...
export default {
  ...
  setup() {
    ...
    const currentDate = ref(new Date().toLocaleDateString()); // Changed to date only
    const refreshInterval = ref(null); // Store the interval ID

    // Update real-time date
    const updateCurrentDate = () => {
      currentDate.value = new Date().toLocaleDateString(); // Changed to date only
    };
